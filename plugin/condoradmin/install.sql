...
) ENGINE=InnoDB AUTO_INCREMENT=1282 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='后台操作日志';
...
CREATE TABLE `con_system_attachment` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='附件表';
...
INSERT INTO `con_system_attachment` (`id`, `type_id`, `admin_id`, `user_id`, `url`, `storage`, `filename`, `filesize`, `mimetype`, `extparam`, `createtime`, `updatetime`, `type`, `sha1`) VALUES (5, 0, 1, 0, '/uploads20260607/94f3cde1ffa0d31da75fa949749ef57985470c85.png', 'local', 'condor_origin.png', 51337, 'image/png', '[]', 1780797581, 1780797581, 'image', '94f3cde1ffa0d31da75fa949749ef57985470c85');
INSERT INTO `con_system_attachment` (`id`, `type_id`, `admin_id`, `user_id`, `url`, `storage`, `filename`, `filesize`, `mimetype`, `extparam`, `createtime`, `updatetime`, `type`, `sha1`) VALUES (6, 0, 1, 0, '/uploads20260607/c69365e028aeb58f67de5f6d97a13d2ad7cde5b4.png', 'local', '卡通风格binlog图片生成.png', 4205624, 'image/png', '[]', 1780797594, 1780797594, 'image', 'c69365e028aeb58f67de5f6d97a13d2ad7cde5b4');
INSERT INTO `con_system_attachment` (`id`, `type_id`, `admin_id`, `user_id`, `url`, `storage`, `filename`, `filesize`, `mimetype`, `extparam`, `createtime`, `updatetime`, `type`, `sha1`) VALUES (7, 0, 1, 0, '/uploads20260607/b1289e0512b3b068b81b806611746434b4581342.png', 'local', '新对话.png', 4795123, 'image/png', '[]', 1780797842, 1780797842, 'image', 'b1289e0512b3b068b81b806611746434b4581342');
INSERT INTO `con_system_attachment` (`id`, `type_id`, `admin_id`, `user_id`, `url`, `storage`, `filename`, `filesize`, `mimetype`, `extparam`, `createtime`, `updatetime`, `type`, `sha1`) VALUES (8, 0, 1, 0, '/uploads20260607/073941aafb624748630a9e388d22798b70c23f80.png', 'local', '新对话 (3).png', 3749187, 'image/png', '[]', 1780797956, 1780797956, 'image', '073941aafb624748630a9e388d22798b70c23f80');
INSERT INTO `con_system_attachment` (`id`, `type_id`, `admin_id`, `user_id`, `url`, `storage`, `filename`, `filesize`, `mimetype`, `extparam`, `createtime`, `updatetime`, `type`, `sha1`) VALUES (9, 0, 1, 0, '/uploads/20260607/b1289e0512b3b068b81b806611746434b4581342.png', 'local', '新对话.png', 4795123, 'image/png', '[]', 1780798234, 1780798234, 'image', 'b1289e0512b3b068b81b806611746434b4581342');
INSERT INTO `con_system_attachment` (`id`, `type_id`, `admin_id`, `user_id`, `url`, `storage`, `filename`, `filesize`, `mimetype`, `extparam`, `createtime`, `updatetime`, `type`, `sha1`) VALUES (10, 0, 1, 0, '/uploads/20260616/e02d0bcf71cbc85d6d31c6951972d50d7498d7c5.jpg', 'local', '41.jpg', 79614, 'image/jpeg', '[]', 1781617687, 1781617687, 'image', 'e02d0bcf71cbc85d6d31c6951972d50d7498d7c5');
INSERT INTO `con_system_attachment` (`id`, `type_id`, `admin_id`, `user_id`, `url`, `storage`, `filename`, `filesize`, `mimetype`, `extparam`, `createtime`, `updatetime`, `type`, `sha1`) VALUES (11, 0, 1, 0, '/uploads/20260616/cceef8a82bb29ed3435fdfc096d5528eb7eb3cdc.jpg', 'local', 'qrcode_for_gh_7ede9422b7d1_344.jpg', 9170, 'image/jpeg', '[]', 1781617707, 1781617707, 'image', 'cceef8a82bb29ed3435fdfc096d5528eb7eb3cdc');
INSERT INTO `con_system_attachment` (`id`, `type_id`, `admin_id`, `user_id`, `url`, `storage`, `filename`, `filesize`, `mimetype`, `extparam`, `createtime`, `updatetime`, `type`, `sha1`) VALUES (12, 0, 1, 0, '/uploads/20260616/cceef8a82bb29ed3435fdfc096d5528eb7eb3cdc.jpg', 'local', 'qrcode_for_gh_7ede9422b7d1_344.jpg', 9170, 'image/jpeg', '[]', 1781618661, 1781618661, 'image', 'cceef8a82bb29ed3435fdfc096d5528eb7eb3cdc');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='配置分组表语言表';
...
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='字典数据表';
...
INSERT INTO `con_system_dict_data` (`id`, `type_id`, `value`, `color`, `weigh`, `status`, `created_by`, `updated_by`, `createtime`, `updatetime`, `deleted_at`) VALUES (62, 9, '1', NULL, 0, 1, 1, NULL, 1781531682, 1781531682, NULL);
INSERT INTO `con_system_dict_data` (`id`, `type_id`, `value`, `color`, `weigh`, `status`, `created_by`, `updated_by`, `createtime`, `updatetime`, `deleted_at`) VALUES (63, 9, '2', NULL, 0, 1, 1, NULL, 1781531705, 1781531705, NULL);
INSERT INTO `con_system_dict_data` (`id`, `type_id`, `value`, `color`, `weigh`, `status`, `created_by`, `updated_by`, `createtime`, `updatetime`, `deleted_at`) VALUES (64, 9, '0', NULL, 0, 1, 1, NULL, 1781531732, 1781531732, NULL);
COMMIT;
...
CREATE TABLE `con_system_dict_data_translations` (
  ...
  `deleted_at` bigint DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=129 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='字典数据表';
...
INSERT INTO `con_system_dict_data_translations` (`id`, `main_id`, `locale`, `label`, `remark`, `createtime`, `updatetime`, `deleted_at`) VALUES (123, 62, 'en-us', 'Male', '', 1781531682, 1781531682, NULL);
INSERT INTO `con_system_dict_data_translations` (`id`, `main_id`, `locale`, `label`, `remark`, `createtime`, `updatetime`, `deleted_at`) VALUES (124, 62, 'zh-cn', '男', '', 1781531682, 1781531682, NULL);
INSERT INTO `con_system_dict_data_translations` (`id`, `main_id`, `locale`, `label`, `remark`, `createtime`, `updatetime`, `deleted_at`) VALUES (125, 63, 'en-us', 'Female', '', 1781531705, 1781531705, NULL);
INSERT INTO `con_system_dict_data_translations` (`id`, `main_id`, `locale`, `label`, `remark`, `createtime`, `updatetime`, `deleted_at`) VALUES (126, 63, 'zh-cn', '女', '', 1781531705, 1781531705, NULL);
INSERT INTO `con_system_dict_data_translations` (`id`, `main_id`, `locale`, `label`, `remark`, `createtime`, `updatetime`, `deleted_at`) VALUES (127, 64, 'en-us', 'Unknown', '', 1781531732, 1781531732, NULL);
INSERT INTO `con_system_dict_data_translations` (`id`, `main_id`, `locale`, `label`, `remark`, `createtime`, `updatetime`, `deleted_at`) VALUES (128, 64, 'zh-cn', '未知', '', 1781531732, 1781531732, NULL);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='字典类型表';
...
INSERT INTO `con_system_dict_type` (`id`, `name`, `scope`, `status`, `created_by`, `updated_by`, `createtime`, `updatetime`, `deleted_at`) VALUES (9, 'gender', 0, 1, 1, NULL, 1781531631, 1781531631, NULL);
COMMIT;
...
CREATE TABLE `con_system_dict_type_translations` (
  ...
  `deleted_at` bigint DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='字典类型表';
...
INSERT INTO `con_system_dict_type_translations` (`id`, `main_id`, `locale`, `title`, `remark`, `createtime`, `updatetime`, `deleted_at`) VALUES (17, 9, 'en-us', 'Gender', '', 1781531631, 1781531631, NULL);
INSERT INTO `con_system_dict_type_translations` (`id`, `main_id`, `locale`, `title`, `remark`, `createtime`, `updatetime`, `deleted_at`) VALUES (18, 9, 'zh-cn', '性别', '', 1781531631, 1781531631, NULL);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='登录日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=127 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='菜单规则';
...
INSERT INTO `con_system_menu_rule` (`id`, `is_keep`, `pid`, `name`, `title`, `icon`, `path`, `component`, `i18nkey`, `remark`, `hidden`, `redirect`, `menu_type`, `href`, `active_menu`, `multi_tab`, `fixed_tab_index`, `query`, `weigh`, `status`, `createtime`, `updatetime`, `deleted_at`) VALUES (120, NULL, NULL, 'condorauth', '授权管理', 'material-symbols:person', '/condorauth', 'layout.base', 'route.condorauth', '', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 7, 1, 1781316518, 1781317178, NULL);
INSERT INTO `con_system_menu_rule` (`id`, `is_keep`, `pid`, `name`, `title`, `icon`, `path`, `component`, `i18nkey`, `remark`, `hidden`, `redirect`, `menu_type`, `href`, `active_menu`, `multi_tab`, `fixed_tab_index`, `query`, `weigh`, `status`, `createtime`, `updatetime`, `deleted_at`) VALUES (121, NULL, 120, 'condorauth_user', '会员管理', 'material-symbols:article-person-outline', '/condorauth/user', 'view.condorauth_user', 'route.condorauth_user', '', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 1781317032, 1781317716, NULL);
INSERT INTO `con_system_menu_rule` (`id`, `is_keep`, `pid`, `name`, `title`, `icon`, `path`, `component`, `i18nkey`, `remark`, `hidden`, `redirect`, `menu_type`, `href`, `active_menu`, `multi_tab`, `fixed_tab_index`, `query`, `weigh`, `status`, `createtime`, `updatetime`, `deleted_at`) VALUES (122, 1, 121, 'core_user_index', '查看', '', '/core/condorauth/user/index', NULL, 'condor.route.view', '', 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 0, 1, 1768722453, 1768722453, NULL);
INSERT INTO `con_system_menu_rule` (`id`, `is_keep`, `pid`, `name`, `title`, `icon`, `path`, `component`, `i18nkey`, `remark`, `hidden`, `redirect`, `menu_type`, `href`, `active_menu`, `multi_tab`, `fixed_tab_index`, `query`, `weigh`, `status`, `createtime`, `updatetime`, `deleted_at`) VALUES (123, 1, 121, 'core_user_add', '添加', '', '/core/condorauth/user/add', NULL, 'condor.route.add', '', 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 0, 1, 1768722453, 1768722453, NULL);
INSERT INTO `con_system_menu_rule` (`id`, `is_keep`, `pid`, `name`, `title`, `icon`, `path`, `component`, `i18nkey`, `remark`, `hidden`, `redirect`, `menu_type`, `href`, `active_menu`, `multi_tab`, `fixed_tab_index`, `query`, `weigh`, `status`, `createtime`, `updatetime`, `deleted_at`) VALUES (124, 1, 121, 'core_user_edit', '编辑', '', '/core/condorauth/user/edit', NULL, 'condor.route.edit', '', 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 0, 1, 1768722453, 1768722453, NULL);
INSERT INTO `con_system_menu_rule` (`id`, `is_keep`, `pid`, `name`, `title`, `icon`, `path`, `component`, `i18nkey`, `remark`, `hidden`, `redirect`, `menu_type`, `href`, `active_menu`, `multi_tab`, `fixed_tab_index`, `query`, `weigh`, `status`, `createtime`, `updatetime`, `deleted_at`) VALUES (125, 1, 121, 'core_user_del', '删除', '', '/core/condorauth/user/del', NULL, 'condor.route.delete', '', 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 0, 1, 1768722453, 1768722453, NULL);
INSERT INTO `con_system_menu_rule` (`id`, `is_keep`, `pid`, `name`, `title`, `icon`, `path`, `component`, `i18nkey`, `remark`, `hidden`, `redirect`, `menu_type`, `href`, `active_menu`, `multi_tab`, `fixed_tab_index`, `query`, `weigh`, `status`, `createtime`, `updatetime`, `deleted_at`) VALUES (126, 1, 121, 'core_user_multi', '批量操作', '', '/core/condorauth/user/multi', NULL, 'condor.route.bulk_actions', '', 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 0, 1, 1768722453, 1768722453, NULL);
COMMIT;
